#ifndef B3_CPU_RIGIDBODY_PIPELINE_H // Originally written by Erwin Coumans
...
public:
	b3CpuRigidBodyPipeline(class b3CpuNarrowPhase* narrowphase, struct b3DynamicBvhBroadphase* broadphaseDbvt, const b3Config& config)
	{
	...
	virtual ~b3CpuRigidBodyPipeline() { delete m_data; }
	...
	int registerPhysicsInstance(float mass, const float* position, const float* orientation, int collidableIndex, int userData)
	{
