...
struct b3DbvtAabbMm
{
	...
	B3_DBVT_INLINE friend bool b3Intersect(const b3DbvtAabbMm& a, const b3DbvtAabbMm& b);
	B3_DBVT_INLINE friend bool b3Intersect(const b3DbvtAabbMm& a, const b3Vector3& b);
	B3_DBVT_INLINE friend b3Scalar b3Proximity(const b3DbvtAabbMm& a, const b3DbvtAabbMm& b);
	B3_DBVT_INLINE friend int b3Select(const b3DbvtAabbMm& o, const b3DbvtAabbMm& a, const b3DbvtAabbMm& b);
	B3_DBVT_INLINE friend void b3Merge(const b3DbvtAabbMm& a, const b3DbvtAabbMm& b, b3DbvtAabbMm& r);
	B3_DBVT_INLINE friend bool b3NotEqual(const b3DbvtAabbMm& a, const b3DbvtAabbMm& b);
...
struct b3DynamicBvh
{
	...
	B3_DBVT_PREFIX
	void collideTT(const b3DbvtNode* root0, const b3DbvtNode* root1, B3_DBVT_IPOLICY);

	B3_DBVT_PREFIX
	void collideTTpersistentStack(const b3DbvtNode* root0, const b3DbvtNode* root1, B3_DBVT_IPOLICY);

	B3_DBVT_PREFIX
	void collideTV(const b3DbvtNode* root, const b3DbvtVolume& volume, B3_DBVT_IPOLICY) const;
	...
	B3_DBVT_PREFIX
	static void rayTest(const b3DbvtNode* root, const b3Vector3& rayFrom, const b3Vector3& rayTo, B3_DBVT_IPOLICY);
...
//
B3_DBVT_INLINE int b3Select(const b3DbvtAabbMm& o, const b3DbvtAabbMm& a, const b3DbvtAabbMm& b)
{
	return (b3Proximity(o, a) < b3Proximity(o, b) ? 0 : 1);
}

//
B3_DBVT_INLINE void b3Merge(const b3DbvtAabbMm& a, const b3DbvtAabbMm& b, b3DbvtAabbMm& r)
{
	for (int i = 0; i < 3; ++i)
	{
		if (a.mi[i] < b.mi[i])
