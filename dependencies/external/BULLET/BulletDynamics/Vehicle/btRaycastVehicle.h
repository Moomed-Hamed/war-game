...
static struct btWheelContactPoint
{
	btRigidBody* m_body0;
	btRigidBody* m_body1;
...
static btScalar calcRollingFriction(btWheelContactPoint& contactPoint, int numWheelsOnGround)
{
	btScalar j1 = 0.f;
...
// used in update_friction function (maybe others as well)
...
public:
	...
	btScalar rayCast(btWheelInfo& wheel)
	{
		...
		if (object)
		{
			...
			{ // getFixedBody();
				...
				wheel.m_raycastInfo.m_groundObject = &s_fixed;  // TODO: for driving on dynamic/movable objects!;
			}
	...
	btWheelInfo& addWheel(const btVector3& connectionPointCS, const btVector3& wheelDirectionCS0, const btVector3& wheelAxleCS, btScalar suspensionRestLength, btScalar wheelRadius, const btVehicleTuning& tuning, bool isFrontWheel)
	{
