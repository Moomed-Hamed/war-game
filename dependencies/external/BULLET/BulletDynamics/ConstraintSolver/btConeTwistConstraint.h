...
static SIMD_FORCE_INLINE btScalar computeAngularImpulseDenominator(const btVector3& axis, const btMatrix3x3& invInertiaWorld)
{
...
protected:
							   ...
							   btScalar& twistAngle, btVector3& vTwistAxis) // all outs
	{
		...
		// if (twistAngle < 0) {} // this should never happen
